...
namespace XmlRpc
{
	...
	class XmlRpcValue
	{
		public:
			...
			XmlRpcValue(bool value) : _type(TypeBoolean)
			{
				_value.asBool = value;
			}
			XmlRpcValue(int value)  : _type(TypeInt)
			{
				_value.asInt = value;
			}
			XmlRpcValue(double value)  : _type(TypeDouble)
			{
			...
			//! Copy
			XmlRpcValue(XmlRpcValue const& rhs) : _type(TypeInvalid)
			{
				*this = rhs;
			}
