...
if(LAPACK_FOUND)
  ...
  GET_FILENAME_COMPONENT(LAPACK_LIBRARY_SUPERDIR "${LAPACK_LIBRARY_DIR}" PATH)
  SET(LAPACK_BIN_DIR "${LAPACK_LIBRARY_SUPERDIR}/bin")
  message("Lapack library dir: ${LAPACK_LIBRARY_DIR}")
  message("Lapack bin dir: ${LAPACK_BIN_DIR}")
endif(LAPACK_FOUND)
